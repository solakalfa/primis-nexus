...
app.get('/api/health', async (_req, res) => {
  ...
  res.json({ ok: true, db, mode: cfg.mode, service: 'primis-nexus-api',
    config: { port: cfg.port, payloadCap: cfg.payloadCap, ratePerMin: cfg.ratePerMin, jsonLimit: cfg.jsonLimit } });
});
